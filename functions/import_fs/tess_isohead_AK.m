function [HeadFile, iSurface] = tess_isohead_AK(nVertices, erodeFactor, fillFactor, Comment,MriFile)
...
% % here is the problem because of not containing scs 
...
%% ===== SAVE FILES =====
HeadFile  =  'data/Inverse/Customized/tess_head_mask.mat';
% Save head
if ~isempty(Comment)
